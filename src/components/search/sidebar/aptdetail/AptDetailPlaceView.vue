          ...
          <div class="accordion-item">
            ...
            >
              <div class="accordion-body">
                <div class="basic-detail-list">
                  <p class="basic-detail-head">
                    <font-awesome-icon icon="fa-solid fa-landmark" /> 관광명소
                  </p>
                  <ul class="basic-detail-body">
                    <li v-for="(land, index) in landmark" :key="index">
                      <strong>{{ land?.place_name }}</strong>
                      (약 {{ Math.round((land?.distance / 1000) * 10) / 10 }}km)
                    </li>
                  </ul>
                </div>
                <div class="basic-detail-list">
                  <p class="basic-detail-head">
                    <font-awesome-icon icon="fa-solid fa-palette" /> 문화시설
                  </p>
                  <ul class="basic-detail-body">
                    <li v-for="(art, index) in art" :key="index">
                      <strong>{{ art?.place_name }}</strong>
                      (약 {{ Math.round((art?.distance / 1000) * 10) / 10 }}km)
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div class="basic-detail-list">
                  ...
                  <ul class="basic-detail-body">
                    <li v-for="(subway, index) in subway" :key="index">
                      <strong
                        >{{ subway?.place_name.split(" ")[1] }}
                        {{ subway?.place_name.split(" ")[0] }}</strong
                      >
                      (약
          ...
          <div class="accordion-item">
            ...
            >
              <div class="accordion-body">
                ...
                <div class="basic-detail-list">
                  <p class="basic-detail-head">
                    <font-awesome-icon icon="fa-solid fa-store" /> 편의점
                  </p>
                  <ul class="basic-detail-body">
                ...
                <div class="basic-detail-list">
                  <p class="basic-detail-head">
                    <font-awesome-icon icon="fa-solid fa-mug-saucer" /> 카페
                  </p>
                  <ul class="basic-detail-body">
...
export default {
  ...
  mounted() {
    if (this.userInfo && this.userInfo.types) {
          ...
          if (this.userInfo) {
            if (this.userInfo.types) {
              for (var i = 0; i < this.userInfo.types.length; ++i) {
                ...
                } else if (this.userInfo.types[i].type == 2) {
                  this.getData("관광", this.lat, this.lng, 10000, "AT4", this.landmark, 4);
                  this.getData("문화", this.lat, this.lng, 10000, "CT1", this.art, 4);
                }
              }
            }
          }
